import { User, Claim, ClaimSeverity, ClaimStatus, ClaimType, ClaimConfirmation, FishboneAnalysisData, TraceabilityAnalysis, RootCauseAnalysis, UserRole, FilterStatus, AppNotification } from '../types';
...
export const claims: Claim[] = [
    {
        ...
        confirmation: ClaimConfirmation.NG,
        errorCausedBy: 'Nguyễn Văn Tùng',
        errorCausedById: 'EMP-D001',
        comments: [
    ...
    },
    {
        ...
        claimType: ClaimType.Internal,
        confirmation: ClaimConfirmation.OK,
        discoveredByDepartment: 'QC',
        errorCausedBy: 'Lê Thị Mai',
        errorCausedById: 'EMP-W002',
        comments: [],
        containmentActions: '',
        rootCauseAnalysis: defaultRootCauseAnalysis,
        correctiveActions: '',
    ...
    },
    {
        ...
        claimType: ClaimType.Customer,
        confirmation: ClaimConfirmation.NG,
        errorCausedBy: 'Trần Văn Hùng',
        errorCausedById: 'EMP-S003',
        comments: [],
    ...
    },
    {
        ...
        errorCausedBy: 'Phạm Minh Đức',
        errorCausedById: 'EMP-SH001',
        comments: [],
    ...
    },
    {
        ...
        claimType: ClaimType.Internal,
        confirmation: ClaimConfirmation.NG,
        discoveredByDepartment: 'Shipping',
        errorCausedBy: 'Vũ Thị Lan',
        errorCausedById: 'EMP-W005',
        comments: [],
        containmentActions: '',
        rootCauseAnalysis: defaultRootCauseAnalysis,
        correctiveActions: '',
    ...
    },
    {
        ...
        orderId: 'PO-77889',
        productCode: 'YK-W-2B-X',
        defectType: 'Lỗi dệt',
        quantity: 25,
        totalQuantity: 800,
        discoveryLocation: 'QC nội bộ',
        responsibleDepartment: 'Weaving',
        description: 'Sợi bị đứt trong quá trình dệt.',
        assignee: users[2], // Le Minh Cuong - Weaving
        creator: users[0],
        status: ClaimStatus.New,
        severity: ClaimSeverity.Medium,
        ...
        confirmation: ClaimConfirmation.NG,
        discoveredByDepartment: 'QC',
        errorCausedBy: 'Nguyễn Thị Hoa',
        errorCausedById: 'EMP-W006',
        comments: [],
        containmentActions: '',
        rootCauseAnalysis: defaultRootCauseAnalysis,
        correctiveActions: '',
    ...
    },
    {
        ...
        orderId: 'PO-99001',
        productCode: 'YK-W-1A-Z',
        defectType: 'Độ căng sợi',
        quantity: 40,
        totalQuantity: 1200,
        discoveryLocation: 'Kiểm tra cuối ca',
        responsibleDepartment: 'Weaving',
        description: 'Độ căng sợi không đều, ảnh hưởng chất lượng sản phẩm.',
        assignee: users[2], // Le Minh Cuong - Weaving
        creator: users[1],
        status: ClaimStatus.InProgress,
        severity: ClaimSeverity.High,
        ...
        claimType: ClaimType.Customer,
        confirmation: ClaimConfirmation.NG,
        errorCausedBy: 'Lý Văn Đức',
        errorCausedById: 'EMP-W007',
        comments: [],
        containmentActions: '',
        rootCauseAnalysis: defaultRootCauseAnalysis,
        correctiveActions: '',
